...
public class WideAwake {
    ...
    public static void main(String[] args) {
        String[][] lyrics = {
            {"Falling from cloud nine (It was out of the blue I'm)", "0.12"},
            {"Crashing from the high", "0.11"},
            {"I'm letting go tonight (Yeah I'm letting you go, Im)", "0.11"},
            {"I'm falling from cloud nine", "0.12"},
            {"(I'm wide awake) Thunder rumbling", "0.13"},
            {"Castles crumbling", "0.15"},
